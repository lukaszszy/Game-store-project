...
<div id="sortMenu">
							...
							<a href="search_category.php?search={$searched}"><div class="sortMenuItem">po nazwie</div></a>
							<a href="search_categoryPASC.php?search={$searched}"><div class="sortMenuItem">po cenie rosnąco</div></a>
							<a href="search_categoryPDESC.php?search={$searched}"><div class="sortMenuItem">po cenie malejąco</div></a>
</div>
